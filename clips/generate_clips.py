# This is a script used to generate the rect coordinates for the clips
# The code is a mess, it needs to be reviewed.
# TBD: a class should be implemented to perform the rectangles search.
...
clip_indexes=sys.argv[3]

if 'prince' in clip_indexes:
    from clip_prince_indexes import *
else:
    from clip_guard_indexes import *
...
content+="#define L2R_X_OFFSET %d\n"%im.size[0]

content+="""
static const SDL_Rect clips[]={
"""
...
content+="""
static const uint16_t state_clips[][4]={
"""
...
void %s_init(figure_t *f)
{
      ...
      f->l2r_x_offset=L2R_X_OFFSET;
}
"""%(file_name,'clips',file_name.upper(),file_name)

content+="""
void %s_get_index(chr_state_t s, const uint16_t **ind)
{
    (*ind)=state_clips[s];
}
